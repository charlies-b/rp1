...
##complexes and proteins in system 
...
##COMPLEXES and PROTEINS RULES IN SYSTEM 
ESXH*=MTB 
ESXG*=MTB 
NDKA*=MTB and not offswitch           #'offswitch' is used for turning specific tb protein in system#
RV2074*=MTB 
SAPM*=MTB and not offswitch

#COMPLEXES and MISC equations#
